...
$content_grid_classes = 'content-card-grid grid gap-4 md:grid-cols-2 xl:grid-cols-4 2xl:grid-cols-5';
$content_card_base_classes = 'content-card flex h-full flex-col overflow-hidden rounded-[28px] border border-slate-200 bg-white shadow-[0_12px_30px_rgba(15,23,42,0.06)]';
$content_card_empty_classes = 'content-card content-card-empty flex h-full flex-col overflow-hidden rounded-[28px] border border-dashed border-slate-200 bg-slate-50 text-center transition hover:border-blue-200 hover:bg-blue-50';
$content_card_body_classes = 'content-card-body flex min-h-[108px] flex-1 flex-col justify-between space-y-3 px-5 py-5';
