...
<div class="adm-page">
    <div class="<?php print(app_page_shell_classes()); ?>">
        ...
        <div
            id="messageStatusMessage"
            class="adm-alert <?php print(h($status_type ?: 'success')); ?> <?php print(app_alert_classes(($status_type ?: 'success') === 'error' ? 'error' : 'success')); ?><?php if ($status_message === '') { print(' hidden'); } ?>"
            role="alert"
        ><?php print(h($status_message)); ?></div>
                            ...
                            <tr class="odd:bg-white even:bg-slate-50/60">
                                ...
                                <td class="border-b border-slate-200/70 px-4 py-4">
                                    <div class="message-visible-cell">
                                        <form class="message-inline-form" method="post" action="<?php print(h($message_page_action)); ?>" data-message-toggle-form data-ajax-skip="1">
                                            ...
                                            <button
                                                ...
                                                data-message-toggle-button
                                                data-class-on="<?php print(h('message-toggle is-on ' . app_toggle_button_classes(true))); ?>"
                                                data-class-off="<?php print(h('message-toggle is-off ' . app_toggle_button_classes(false))); ?>"
                                                aria-label="<?php print($is_visible ? 'OFF に切り替え' : 'ON に切り替え'); ?>"
                                            >
                                                <span
                                                    class="message-toggle-switch <?php print(app_toggle_switch_classes($is_visible)); ?>"
                                                    data-message-toggle-switch
                                                    data-class-on="<?php print(h('message-toggle-switch ' . app_toggle_switch_classes(true))); ?>"
                                                    data-class-off="<?php print(h('message-toggle-switch ' . app_toggle_switch_classes(false))); ?>"
                                                    aria-hidden="true"
                                                >
                                                    <span
                                                        class="block <?php print(app_toggle_knob_classes($is_visible)); ?>"
                                                        data-message-toggle-knob
                                                        data-class-on="<?php print(h('block ' . app_toggle_knob_classes(true))); ?>"
                                                        data-class-off="<?php print(h('block ' . app_toggle_knob_classes(false))); ?>"
                                                    ></span>
                                                </span>
                                                <span class="message-toggle-label text-[11px]" data-message-toggle-label><?php print($is_visible ? 'ON' : 'OFF'); ?></span>
                                            </button>
                                        </form>
                                    </div>
                                </td>
                                <td class="border-b border-slate-200/70 px-4 py-4">
                                    <div class="message-table-actions flex flex-wrap justify-end gap-2">
                                        ...
                                        <form class="message-inline-form" method="post" action="<?php print(h($message_page_action)); ?>" data-ajax-skip="1">
                                            <input type="hidden" name="s" value="<?php print($station_id); ?>">
                                            <input type="hidden" name="message_id" value="<?php print($row_message_id); ?>">
        ...
        >
            <div class="app-modal-dialog app-modal-dialog-lg <?php print(app_modal_dialog_classes('lg')); ?>">
                <div class="app-modal-card message-modal-card <?php print(app_modal_card_classes()); ?>">
                    <form id="messageForm" class="message-form" method="post" action="<?php print(h($message_page_action)); ?>" data-ajax-skip="1">
        ...
        <section class="adm-panel <?php print(app_panel_classes()); ?>">
            ...
            <form id="messageSpeedForm" class="message-form" method="post" action="<?php print(h($message_page_action)); ?>" data-ajax-skip="1">
                <input type="hidden" name="s" value="<?php print($station_id); ?>">
