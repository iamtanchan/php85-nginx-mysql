...
<body class="<?php print(app_body_classes('display')); ?>">
    ...
    <div class="display-shell mx-auto flex min-h-screen w-full max-w-[1920px] flex-col gap-5 px-5 py-5 lg:px-8 lg:py-8">
        ...
        <div class="display-panel notify-panel fixed inset-0 z-40 hidden" id="notifyPanel" hidden>
            <section class="notify-stage h-full overflow-hidden bg-slate-950" id="notifyStage" aria-label="通知表示">
                <div class="grid h-full gap-0 xl:grid-cols-[1.25fr_minmax(320px,0.75fr)]">
